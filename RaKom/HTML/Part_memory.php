...
$sql = "SELECT * FROM mem;";
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<tr><th>Nama memory</th><th>SPEED</th><th>Module</th><th>Color</th><th>Price</th></tr>";
        while($row = $result->fetch_assoc()) {
        echo "<tr><th>" . $row["mem_name"]. "</th><th>" . $row["mem_speed"]. "</th><th>". $row["mem_module"]. "</th><th>". $row["mem_color"]. "</th><th>". $row["mem_price"]. "</th></tr>";
        }
    } else {
        echo "0 results";
    }
